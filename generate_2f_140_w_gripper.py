...
def start_2f_140_gripper(txt_dir, ratio):

    # scaling fingers  
        
    # scaling palm
    rescaling(txt_dir,ratio,"robotiq_arg2f_base_link")   
    
    # scaling palm
    rescaling(txt_dir,ratio,"outer_knuckle")

    # scaling inner_knuckle_joint
    rescaling(txt_dir,ratio,"inner_knuckle")

    # scaling outer_finger
    rescaling(txt_dir,ratio,"outer_finger")

    # scaling inner_finger_pad
    rescaling(txt_dir,ratio,"inner_finger")

    # scaling inner_finger_pad
    rescaling(txt_dir,ratio,"inner_finger_pad")

    # relocate inner_finger_joint
    #relocate(txt_dir,ratio_1, "inner_finger_joint")

    # relocate inner_finger_pad_joint
    #relocate(txt_dir,ratio_2, "inner_finger_pad_joint")





def generate_2f_140_w_gripper():
